...
var APP = {
  ...
  resultUpdate: function (name) {
    let tdic;
    if (name === 'Diffuse Field') tdic = DF;
    else if (name === 'Free Field') tdic = FF;
    else if (name === 'Diffuse Field+Gain') tdic = DFG;
    else if (name === 'Free Field+Gain') tdic = FFG;
    else if (name === 'Harman OE2013') tdic = OE2013;
    else if (name === 'Harman OE2015') tdic = OE2015;
    else if (name === 'Harman OE2017') tdic = OE2017;
    else if (name === 'Harman IE2017') tdic = IE2017;
    else tdic = OE2017;
